...
export class ModifiedThresholdsEditor extends PureComponent<Props, State> {
...
export const ColorBindingEditor: React.FC<StandardEditorProps<ThresholdsConfig>> = ({ value, onChange }) => {
  return <ModifiedThresholdsEditor onChange={(e) => onChange(e)} thresholds={value} />;
};
